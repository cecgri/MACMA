...
#ifndef RIGHT_SUBDUCTION_H_
#define RIGHT_SUBDUCTION_H_

#include "MACMA/physics/subduction.h"

/*
==================================================
 Class RightSubduction : extends Subduction
 -------------------------------------------------
 - Velocity law : U = U_rightPlate
==================================================
*/

class RightSubduction : public Subduction
{
 public:
  RightSubduction(Earth* earth, double position);
  ~RightSubduction();
  
  // --- GeoElement
  inline bool isA(string className) { return className == "RightSubduction" || 
