...
using namespace std;
// ==================================================
LeftContinentExtremity::LeftContinentExtremity(Earth* earth, Continent* continent) : ContinentExtremity(earth, continent)
{
  _id = Earth::getId("LeftContinentExtremity");
  _position = _continent->getLeftPosition();
}

LeftContinentExtremity::~LeftContinentExtremity()
{
}
// ==================================================
void
LeftContinentExtremity::modifyVelocity()
{
  _U += _growthRate;
  _neighbor->setU(_U);
}
